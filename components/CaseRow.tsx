...
export function CaseRow({ caseData }: { caseData: UAPCase }) {
  ...
  return (
    <a
      ...
      className="group flex items-center gap-4 border-b border-border py-3 transition hover:bg-panel"
    >
      ...
      <span className={`w-10 text-right font-mono text-xs ${tierColor}`}>
        Tier {caseData.tier}
      </span>
      <span className="w-12 text-right font-mono text-sm font-bold text-text">
