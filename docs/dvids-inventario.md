# Inventario · videos DVIDS `DOW-UAP-PR*` por entrega PURSUE

Catálogo público de DVIDS cruzado contra el corpus. **Generado ago 2026.**
...
**Barrido por siglas alternativas (ago 2026, tras pedido explícito del usuario)**: con PURSUE y la serie AARO CRR cerrados, se probaron 14 términos de búsqueda adicionales en DVIDS no usados hasta ahora —`UAPTF`, `unidentified anomalous phenomena`, `AARO`, `USSF-UAP`, `SPACECOM-UAP`, `ODNI-UAP`, `HPSCI-UAP`, `NGA-UAP`, `DIA-UAP`, `STRATCOM-UAP`, `AATIP`, `Project Blue Book`, `UFO`, `anomalous phenomena`— comparando cada resultado contra los 154 IDs de video ya embebidos en el corpus. De ~74 resultados únicos, solo 8 eran genuinamente nuevos, y de esos 8 solo uno era contenido real relacionado (los otros 7 son falsos positivos por coincidencia de sigla o palabra: un evento de tropas de STRATCOM 2013, un equipo de ingeniería civil también llamado "AARO", dos videos de la nebulosa de Orión del Hubble, un perfil de veterano, un sargento instructor, y un video del 4 de julio).

El hallazgo real: `950338`, "The Satellite Flaring Phenomenon" — una animación educativa oficial de la AARO/DoD que explica el mecanismo óptico de destello satelital (reflejo solar en antenas/paneles) como causa de mala identificación de UAP. No es metraje de un incidente, así que no encaja como documento embebido de un caso — se agregó como fuente de referencia (no embebida) en [[fbi-pilot-recurring-lights-2023-2024]], el único caso del corpus donde el testigo descarta explícitamente "destellos de Starlink" como explicación de las luces que reporta. Con este barrido, las siglas y organismos gubernamentales conocidos relacionados con UAP (AARO, UAPTF, FBI, además de los comandos combatientes) quedan cubiertos; no se descarta que aparezca contenido nuevo si DVIDS publica una entrega futura.
...
- [x] `PR19` · 05.01.2022 — unresolved-uap-report-middle-east-may-2022 → `dow-centcom-2020` · [ver](https://www.dvidshub.net/video/1006056)
- [x] `PR21` · 05.01.2022 — unresolved-uap-report-iraq-may-2022 → `dow-centcom-2020` · [ver](https://www.dvidshub.net/video/1006059)
- [x] `PR22` · 07.01.2022 — unresolved-uap-report-syria-july-2022 → `dow-centcom-2020` · [ver](https://www.dvidshub.net/video/1006060)
- [x] `PR23` · 12.01.2022 — unresolved-uap-report-iraq-december-2022 → `dow-centcom-2020` · [ver](https://www.dvidshub.net/video/1006062)
...
- [x] `PR117` · 09.08.2021 — unresolved-uap-report-gulf-oman-2021 → `gulf-of-oman-2021` · [ver](https://www.dvidshub.net/video/1017793)
- [x] `PR118` · 09.08.2021 — unresolved-uap-report-gulf-oman-2021 → `gulf-of-oman-2021` · [ver](https://www.dvidshub.net/video/1017795)
- [x] `PR119` · 09.08.2021 — unresolved-uap-report-gulf-oman-2021 → `gulf-of-oman-2021` · [ver](https://www.dvidshub.net/video/1017798)
...
- [x] id 960331 ("Al Taqaddum Object", hallado vía `q=AARO+video`; oct 2017, Irak, 17 min continuos resueltos por la AARO como racimo de globos con análisis de píxeles + geolocalización del aeróstato) → caso propio `al-taqaddum-balloons-2017`.

**Tercera pasada (`q=CIA/DOE/Army/NGA/NRO-UAP`, `q=unidentified anomalous phenomena`, `q=AARO video`, `q=Malmstrom/Skinwalker/balloon shootdown`)**: sin más hallazgos nuevos — los resultados fueron o bien contenido ya catalogado, o falsos positivos de keyword genérico (ej. "NRO-UAP" solo trae videos institucionales de la NRO sin relación). Se revisaron también los 27 casos del backlog visual E21 buscando sus nombres/eventos en DVIDS (Aguadilla ya cerrado arriba; jellyfish-iraq-2018 y afghanistan-isr-disc-2020 son metraje filtrado por Corbell/Knapp, nunca liberado oficialmente — sin mirror esperable en DVIDS). Barrido de DVIDS considerado agotado por ahora.
