    ...
    <article className="prose mx-auto max-w-2xl space-y-8 text-text">
      ...
      <section className="space-y-4">
        ...
        <ol className="list-decimal space-y-3 pl-6 text-text">
          <li>
            Hay un fenómeno físico real que los gobiernos llevan documentando
            desde 1947 y que ningún marco interpretativo único explica
            completamente.
          </li>
          <li>
            En mayo 2026, Estados Unidos liberó archivos masivos sobre UAP
            (PURSUE) — pero la liberación fue cuidadosamente curada para no
            afirmar ni negar nada sustantivo.
          </li>
          <li>
            La forma en que se está liberando información importa más que el
            contenido liberado.
          </li>
        </ol>
      </section>
      ...
      <section className="space-y-4">
        ...
        <Finding
          title="1. El fenómeno es real (~95% confianza)"
        ...
        />
        <Finding
          title="2. No es UNA cosa — son varias"
        ...
        />
        <Finding
          title="3. Los gobiernos saben más de lo que dicen (~95% confianza)"
        ...
        />
        <Finding
          title="4. PURSUE 2026 NO es disclosure real — es ambigüedad estratégica"
          text="Mano derecha: abre archivos. Mano izquierda: propuesta OPM NDA (26 may) silencia futuros whistleblowers federales."
        />
        <Finding
          title="5. El framework de Vallée (1975) predijo PURSUE 2026"
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold text-text">
          La taxonomía de disclosure
        </h2>
        <p>
          El aporte analítico central del corpus. Cualquier evento UAP
          institucional cae en una de cuatro categorías:
        </p>
        <ul className="space-y-2 pl-6 text-sm">
          ...
          <li>
            <span className="font-mono text-accent">8n</span> Ambigüedad
            estratégica — "miren todo, decidan ustedes" (PURSUE 2026)
          </li>
          <li>
            <span className="font-mono text-accent">8q</span> Ecosystem de
            disclosure — políticos + periodistas + whistleblowers fuerzan
            apertura
          </li>
          <li>
            <span className="font-mono text-accent">8r</span> Leaks/WikiLeaks
            — alguien filtró sin permiso
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <blockquote className="border-l-4 border-accent bg-panel p-4 italic text-text">
      ...
      <div className="flex flex-wrap gap-3 border-t border-border pt-6">
        <a
          href="/cases"
          className="rounded-md bg-accent px-4 py-2 text-sm font-medium text-bg hover:bg-accent/90"
        >
          Explorar {TOTAL_CASES} casos →
        </a>
        <a
          href="/atlas"
          className="rounded-md border border-border px-4 py-2 text-sm font-medium text-text hover:bg-panel"
        >
          Ver mapa
        </a>
        <a
