            ...
            <div className="mt-6 space-y-6">
              <Body className="text-muted">
                <T
                  ...
                  en="Of the six main corpus explanations, five are reasonably settled — classified programs near the top with documented historical evidence (U-2, F-117), and the three specific subclasses (interdimensional, non-materialist ontological, formal treaty) near the bottom because their evidence is testimonial or lacks primary documents. The sixth, broad non-human entities, is the only one a single decisive experiment could move. That's where the corpus debate lives."
                />
              </Body>
          ...
          <details className="group border-b border-text/15 pb-6">
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="mt-10 space-y-4 border-t border-text/15 pt-8">
                ...
                <Body className="text-muted">
                  <T
                    es={<>Las probabilidades del corpus se derivan en build-time siguiendo una fórmula pública:{" "}<strong className="text-text">probabilidad = prior + presión × 0.5</strong>. El <em>prior</em> es el juicio del analista antes de mirar el corpus; la <em>presión</em> es la suma de las contribuciones declaradas por cada caso del corpus. Cada caso nuevo recalibra automáticamente todas las probabilidades del sitio sin intervención humana.</>}
                    en={<>Corpus probabilities are derived at build-time following a public formula:{" "}<strong className="text-text">probability = prior + pressure × 0.5</strong>. The <em>prior</em> is the analyst&apos;s judgment before looking at the corpus; the <em>pressure</em> is the sum of declared contributions from each corpus case. Every new case auto-recalibrates all probabilities site-wide without human intervention.</>}
                  />
                </Body>
                <Body className="text-muted">
                  <T
