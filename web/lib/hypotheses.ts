...
const RAW: Array<Omit<Hypothesis, "icd">> = [
  ...
  },
  {
    ...
    prose: "Es la hipótesis del 'mundo conocido extendido': tecnología real, humana, no reconocida públicamente. El historial empírico la sostiene fuerte —el U-2 fue confundido con OVNIs durante años antes de ser desclasificado en 1976; el F-117 ya volaba en operaciones cuando aún era reportado como triángulo no identificado sobre Nevada; los drones experimentales actuales sobre rangos de prueba siguen generando reportes que la USAF declina aclarar. Que esta hipótesis explique varios casos del corpus es prácticamente seguro: la mecánica institucional de los black programs (compartimentación, cobertura mediante misidentificación deliberada, demoras de desclasificación de 20-40 años) está documentada. Lo que NO resuelve son los casos con performance que excede el state-of-the-art conocido —Nimitz 2004, Tehran 1976, los videos GIMBAL/GOFAST— donde físicos honestos dicen 'esto no encaja con ningún programa conocido', pero tampoco pueden afirmar con seguridad que no existe un programa que sí lo haga. Por eso el prior alto y el techo bajo simultáneo: explica mucho del corpus, pero deja casos críticos sin tocar. Nota analítica: esta hipótesis cubre solo programas US/aliados; la tecnología operada encubiertamente por adversarios (China, Rusia) vive en `tecnologia-adversaria`, y la posibilidad de programas US de ingeniería inversa sobre tecnología no humana recuperada vive en `ingenieria-inversa`. Mantener las tres separadas es prerequisito para análisis riguroso.",
    proseEn: "It's the 'extended known world' hypothesis: real, human technology, not publicly acknowledged. The empirical record sustains it strongly —the U-2 was mistaken for UFOs for years before declassification in 1976; the F-117 was already in operational flight while still reported as an unidentified triangle over Nevada; current experimental drones over test ranges keep generating reports the USAF declines to clarify. That this hypothesis explains several corpus cases is practically certain: the institutional mechanics of black programs (compartmentalization, cover via deliberate misidentification, 20-40 year declassification lags) are documented. What it does NOT resolve are the cases with performance exceeding known state-of-the-art —Nimitz 2004, Tehran 1976, the GIMBAL/GOFAST videos— where honest physicists say 'this does not fit any known program', but also cannot confidently assert that no such program exists. Hence the simultaneous high prior and low ceiling: it explains much of the corpus, but leaves the critical cases untouched. Analytical note: this hypothesis covers only U.S./allied programs; technology covertly operated by adversaries (China, Russia) lives in `tecnologia-adversaria`, and the possibility of U.S. reverse-engineering programs on recovered non-human technology lives in `ingenieria-inversa`. Keeping the three separate is a prerequisite for rigorous analysis.",
  },
  {
    id: "tecnologia-adversaria",
    kind: "primitive",
    label: "≥1 caso es tecnología militar adversaria (China, Rusia)",
    labelEn: "≥1 case is adversary military technology (China, Russia)",
    corpusPct: 60,
    color: "#6b3023",
    note: "Tecnología de inteligencia/militar de potencias adversarias operada encubiertamente sobre territorio occidental. Globos chinos sobre Montana 2023 confirmados oficialmente; drones rusos sobre bases OTAN reportados desde 2022; Mystery Drones East Coast 2024 con origen abierto.",
    noteEn: "Adversary military/intelligence technology covertly operated over Western territory. Chinese balloons over Montana 2023 officially confirmed; Russian drones over NATO bases reported since 2022; East Coast Mystery Drones 2024 with open origin.",
    prose: "Hipótesis distinta de `programas-clasificados` aunque a menudo se confunden con ella. Afirma que al menos un caso del corpus es **tecnología de inteligencia o militar de una potencia adversaria** —típicamente China o Rusia— operada encubiertamente sobre territorio occidental sin reconocimiento institucional inmediato. Su evidencia track-record es sólida y reciente: el globo chino derribado sobre la costa de Carolina del Sur en febrero 2023 fue confirmado oficialmente por el DoD como instrumento de inteligencia y reveló una serie histórica de globos chinos sobre territorio estadounidense que el AARO admitió posteriormente. Los Mystery Drones sobre New Jersey en noviembre-diciembre 2024 fueron investigados por DHS y AARO; el origen quedó oficialmente abierto. Su prior alto (60%) refleja que el espionaje aéreo adversario es una clase de fenómeno verificada, no especulativa. Lo que la distingue de `programas-clasificados` es la geopolítica: si Nimitz 2004 fue tecnología US no reconocida es una pregunta sobre cover-up doméstico; si fue tecnología china avanzada es una pregunta sobre fallo de defensa aérea —dos lecturas con consecuencias operativas opuestas. Distinguirlas en el corpus es prerequisito para que el análisis tenga utilidad de seguridad nacional.",
    proseEn: "Hypothesis distinct from `programas-clasificados` though they are often conflated. It claims that at least one corpus case is **intelligence or military technology of an adversary power** —typically China or Russia— operated covertly over Western territory without immediate institutional acknowledgment. Its track-record evidence is solid and recent: the Chinese balloon shot down off the South Carolina coast in February 2023 was officially confirmed by the DoD as an intelligence instrument and revealed a historical series of Chinese balloons over U.S. territory that AARO later acknowledged. The Mystery Drones over New Jersey in November-December 2024 were investigated by DHS and AARO; the origin remained officially open. Its high prior (60%) reflects that adversary aerial espionage is a verified, not speculative, class of phenomenon. What distinguishes it from `programas-clasificados` is the geopolitics: whether Nimitz 2004 was unacknowledged U.S. technology is a question about domestic cover-up; whether it was advanced Chinese technology is a question about air-defense failure —two readings with opposite operational consequences. Distinguishing them in the corpus is a prerequisite for the analysis to have national-security utility.",
  },
  {
  ...
  },
  {
    ...
    kind: "primitive",
    label: "Existe ≥1 programa US/aliado de ingeniería inversa de tech no humana",
    labelEn: "≥1 U.S./allied program of reverse-engineering of non-human tech exists",
    corpusPct: 30,
    color: "#4a3a78",
    ...
    prose: "Hipótesis condicionalmente derivada: requiere que tanto `entidades-no-humanas` como `programas-clasificados` sean verdaderas en al menos un caso del corpus. Por cota de Fréchet su prior tiene como techo el mínimo de las dos primitivas (~49% según calibración actual de entidades-no-humanas). Pero RE no es solo la conjunción —es la afirmación específica de que existe un programa US/aliado **formal** de recuperación + reverse engineering de tecnología no humana. Esa afirmación tiene defensores institucionalmente serios: el testimonio bajo juramento de David Grusch en julio 2023 ante el Congreso, los DIRDs de AAWSAP que la DIA encargó a Puthoff y Davis sobre warp drives y manipulación de métrica, el libro 'Skinwalkers at the Pentagon' (Lacatski, Kelleher, Knapp 2021) escrito desde adentro del programa, y la claim sostenida de Bob Lazar desde 1989 sobre S-4 y el elemento 115. Lo que NO tiene es documentos primarios desclasificados: ninguna directiva, ningún memorándum interno, ninguna foto o material analizado por laboratorio independiente. Su prior de 30% es la calibración honesta de 'asume que las dos primitivas son verdaderas, pero acepta que no hay evidencia documental primaria del programa formal'. Es la afirmación específica que más se beneficiaría de un release ejecutivo bajo la directiva Trump de mayo 2026 si los archivos que Grusch identificó por nombre fueran efectivamente desclasificados.",
    proseEn: "Conditionally derived hypothesis: it requires both `entidades-no-humanas` and `programas-clasificados` to be true in at least one corpus case. By the Fréchet bound its prior is capped at the minimum of the two primitives (~49% per current calibration of entidades-no-humanas). But RE is not just the conjunction —it is the specific claim that there exists a **formal** U.S./allied program of recovery + reverse engineering of non-human technology. That claim has institutionally serious defenders: David Grusch's July 2023 sworn testimony before Congress, the AAWSAP DIRDs the DIA commissioned from Puthoff and Davis on warp drives and metric engineering, the book 'Skinwalkers at the Pentagon' (Lacatski, Kelleher, Knapp 2021) written from inside the program, and Bob Lazar's sustained claim since 1989 about S-4 and element 115. What it does NOT have are declassified primary documents: no directive, no internal memorandum, no photograph or material analyzed by an independent laboratory. Its 30% prior is the honest calibration of 'assume the two primitives are true, but accept that there is no primary documentary evidence of the formal program'. It is the specific claim that would most benefit from an executive release under the May 2026 Trump directive if the files Grusch identified by name were effectively declassified.",
  },
  {
    id: "interdimensional",
    kind: "primitive",
