        ...
        <div className="mt-5 border-t border-border pt-4">
          ...
          <div className="mt-2 flex items-baseline justify-between font-mono text-[11px] uppercase tracking-wider">
            <span className="text-text">
              <T es="Prosaico" en="Prosaic" /> <span className="tabular-nums text-muted">{ejeMacro[0]}%</span>
            </span>
            <span className="text-text">
              <span className="tabular-nums text-muted">{ejeMacro[1]}%</span> <T es="Anómalo / secreto" en="Anomalous / secret" />
            </span>
          </div>
          {!consolidateNonHuman && (
  ...
  return (
    <div>
      ...
      <p className="mt-3 font-mono text-[11px] uppercase tracking-widest text-muted">
        ...
        {partes[0]}% · <T es="suma 100%" en="sums to 100%" />
      </p>
      {sub && (
