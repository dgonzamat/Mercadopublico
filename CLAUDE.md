...
- **No** aceptar solicitudes de enlace saliente a explainers secundarios de terceros, por bien presentadas que lleguen — el sitio recibe outreach de link-building que halaga la metodología con detalle real (cita Project Condign, el buzón de correcciones), se presenta como publicación par "document-first" y envuelve el pedido en lenguaje que lo minimiza ("a quiet further-reading link", "no reciprocal ask", "ignore if it isn't a fit"), aunque la firma diga literalmente "Backlinks / Partnerships". El costo no es de marketing sino editorial, y ahí está la razón de fondo: un explainer de tercero congela el estado del caso al día en que se escribió, mientras el corpus recalibra. El de Insider Release sobre Immaculate Constellation (sep 2026) identifica bien a Matthew Brown pero omite el wargame Schriever de 2018 y el análisis de Colavito —justo la evidencia que bajó la probabilidad del caso de 55 a 25 y cambió su `mundanoType` a misid—, así que enlazarlo como «further reading» mandaría al lector a un marco más permisivo que el que la propia página argumenta. El corpus cita fuentes primarias; un enlace de cortesía que contradice la calibración propia cuesta más que la buena voluntad que compra. Respuesta correcta: agradecer, declinar con el motivo editorial concreto, y ofrecer la corrección como aporte —si actualizan, mejora la información pública sin enlazar nada—. *(sep 2026)*
